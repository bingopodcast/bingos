...
from bingo_emulator.graphics.venice import *
...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        if self.game.start.status == True:
            ...
            self.regular_play()
        self.delay(name="display", delay=0.1, handler=graphics.venice.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh venice")
        else:
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.venice.reel1, graphics.venice.reel10, graphics.venice.reel100, graphics.venice.reel1000)
                self.game.coils.registerDown.pulse()
                number -= 1
                self.delay(name="display", delay=0, handler=graphics.venice.display, param=self)
    ...
    def replay_step_up(self):
        if self.game.replays < 8999:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.venice.reel1, graphics.venice.reel10, graphics.venice.reel100, graphics.venice.reel1000)
    ...
    def check_special(self, num):
        ...
        if self.game.special_game.position == 0:
            if even == True:
                self.game.special_game.step()
            else:
                self.game.missed.engage(self.game)
                self.game.sound.play('tilt')
        elif self.game.special_game.position == 1:
            if even == False:
                self.game.special_game.step()
            else:
                self.game.missed.engage(self.game)
                self.game.sound.play('tilt')
        elif self.game.special_game.position == 2:
            if even == True:
                self.game.special_game.step()
            else:
                self.game.missed.engage(self.game)
                self.game.sound.play('tilt')
        elif self.game.special_game.position == 3:
            if even == False:
                self.game.special_game.step()
            else:
                self.game.missed.engage(self.game)
                self.game.sound.play('tilt')
        elif self.game.special_game.position == 4:
            if even == True:
                self.game.special_game.step()
            else:
                self.game.missed.engage(self.game)
    ...
    def search(self):
        ...
        for i in range(0, 6):
            ...
            if self.game.special_game.position >= 3 and self.game.missed.status == False:
            ...
            if relays == 4:
                if stars:
                    if self.game.six_stars.status == True:
                        if self.game.stars_replay_counter.position < 900:
                            self.game.search_index.engage(self.game)
                            self.stars_replay_step_up(900 - self.game.stars_replay_counter.position)
                    elif self.game.three_stars.status == True:
                        if self.game.stars_replay_counter.position < 450:
                            self.game.search_index.engage(self.game)
                            self.stars_replay_step_up(450 - self.game.stars_replay_counter.position)
                else:
    ...
    def animate_special(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.venice.special_animation([self, start + num])
    ...
    def animate_odds_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.venice.odds_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_line1(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.venice.line1_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_line2(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.venice.line2_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_line3(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.venice.line3_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_features_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.venice.feature_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.venice.both_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.venice.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class Venice(procgame.game.BasicGame):
    """ Venice was an early Mystic Lines game with the solid state special game """
    def __init__(self, machine_type):
        super(Venice, self).__init__(machine_type)
        ...
        #Odds steppers
        self.red_odds = units.Stepper("red_odds", 10, 'venice')
        self.yellow_odds = units.Stepper("yellow_odds", 10, 'venice')
        self.green_odds = units.Stepper("green_odds", 10, 'venice')
        self.blue_odds = units.Stepper("blue_odds", 10, 'venice')
        ...
        self.line1 = units.Stepper("line1", 3, "venice", "continuous")
        self.line2 = units.Stepper("line2", 1, "venice", "continuous")
        self.line3 = units.Stepper("line3", 1, "venice", "continuous")
        ...
        self.special_odds = units.Stepper("special_odds", 9, 'venice')
