...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh bway")
    ...
    def odds_probability(self):
        ...
        if self.game.odds.position == 1:
            ...
            if self.game.odds.position == 2:
                if sd in [0,2,3,6] or sd in range(7,10) or sd in [11,13] or sd in range(15,19) or sd in [21,23,25] or sd in range(30,33) or sd in [36,37,39,40,42,45,47,50]:
                    return 1
                else:
                    return 0
            elif self.game.odds.position == 3:
                if sd in [0,2,3] or sd in range(8,11) or sd == 14 or sd in range(16,19) or sd in [21,23] or sd in range(30,33) or sd in range(37,40) or sd in [41,45,46,49]:
                    return 1
                else:
                    return 0
            elif self.game.odds.position == 4:
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.broadway.both_animation([self, start + num])
    ...
    def animate_squarea(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.broadway.squarea_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_squareb(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.broadway.squareb_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squarec(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.broadway.squarec_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squared(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.broadway.squared_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.broadway.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class Broadway(procgame.game.BasicGame):
    """ Broadway is the first Magic Squares game """
