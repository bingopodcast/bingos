...
class SinglecardBingo(procgame.game.Mode):
    ...
    def check_mixer3(self):
        ...
        if self.game.m_lines.status == False:
            if m3 in [3,5,10,11,13,17,19,21,22,1]:
                return 1
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.gayety.both_animation([self, start + num])
    ...
    def animate_line1(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.gayety.line1_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_line2(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.gayety.line2_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_line3(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.gayety.line3_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.gayety.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class Gayety(procgame.game.BasicGame):
    """ Gayety was the first game with Magic Pockets """
    def __init__(self, machine_type):
        ...
        self.line1 = units.Stepper("line1", 3, "gayety", "continuous")
        self.line2 = units.Stepper("line2", 3, "gayety", "continuous")
        self.line3 = units.Stepper("line3", 3, "gayety", "continuous")
