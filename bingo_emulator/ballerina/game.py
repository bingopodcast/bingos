...
from bingo_emulator.graphics.ballerina import *
...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        ...
        self.delay(name="display", delay=0.1, handler=graphics.ballerina.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh ballerina")
        else:
    ...
    def regular_play(self, red_letter=0):
        ...
        if self.game.start.status == True:
            ...
            self.game.one_seven_feature.disengage()
            ...
            self.game.seven_one.disengage()
            self.game.one_seven.engage(self.game)
    ...
    def magic_screen_reset_up(self, number):
        if number != 2:
            self.game.magic_screen.step()
            self.delay(name="display", delay=0, handler=graphics.ballerina.display, param=self)
            number += 1
        ...
        if self.game.ball_count.position > 0:
            ...
            if self.game.before_fourth.status == True:
                ...
                if self.game.after_fifth.status == True:
                    max_ball = 6
            if self.game.ball_count.position < max_ball:
                if self.game.one_seven_feature.status == True:
                    self.game.one_seven.disengage()
                    self.game.seven_one.engage(self.game)
    ...
    def sw_hole1_active_for_40ms(self, sw):
        if self.game.tilt.status == False and self.game.start.status == False:
            if self.game.one_seven.status == True:
                self.holes.append(1)
            else:
                self.holes.append(7)
            self.delay(name="display", delay=0.1, handler=graphics.ballerina.display, param=self)
...
#        self.cancel_delayed(name="blink_title")
        graphics.ballerina.display(self)
        self.tilt_actions()
#        self.delay(name="blink_title", delay=1, handler=self.blink_title)
        self.replay_step_down(self.game.replays)

    def sw_redstar_active(self, sw):
        if self.game.rollovers.status == True and self.game.magic_screen_feature.position >= 4:
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.ballerina.reel1, graphics.ballerina.reel10, graphics.ballerina.reel100)
    ...
    def replay_step_up(self):
        if self.game.replays < 899:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.ballerina.reel1, graphics.ballerina.reel10, graphics.ballerina.reel100)
...
#        self.cancel_delayed(name="blink_title")
    ...
    def find_section_winners(self):
        ...
        return (self.red, self.yellow, self.green, self.blue, self.red_winner, self.yellow_winner, self.green_winner, self.blue_winner, self.red_ss_winner, self.yellow_ss_winner, self.big_green_winner, self.small_green_winner, self.top_red_winner, self.bottom_yellow_winner, self.top_left_yellow_winner, self.big_red_winner)


    def find_winner(self, relays, red, yellow, green, blue, red_winner=0, yellow_winner=0, green_winner=0, blue_winner=0, red_ss_winner=0, yellow_ss_winner=0, big_green_winner=0, small_green_winner=0, top_red_winner=0, bottom_yellow_winner=0, top_left_yellow_winner=0, big_red_winner=0):
        if self.game.search_index.status == False and self.game.replays < 899:
            ...
            if relays == 3 or red_winner == 3 or yellow_winner == 3 or green_winner == 3 or red_ss_winner == 3 or yellow_ss_winner == 3 or blue_winner == 3 or big_green_winner == 3 or small_green_winner == 3 or top_red_winner == 3 or bottom_yellow_winner == 3 or top_left_yellow_winner == 3 or big_red_winner == 3:
                    if red_ss_winner == 3:
                        if self.game.search_index.status == False:
                            if self.game.red_super_section.status == True:
                        ...
                        if self.game.search_index.status == False:
                            if self.game.yellow_super_section.status == True:
                                ...
                                if self.game.yellow_replay_counter.position < yellowthreeodds:
                                    self.game.search_index.engage(self.game)
                                    self.yellow_replay_step_up(yellowthreeodds - self.game.yellow_replay_counter.position)
                    if (red == 1 and relays == 3) or top_red_winner == 3 or big_red_winner == 3:
                        if self.game.search_index.status == False:
                            if self.game.red_replay_counter.position < redthreeodds:
                                self.game.search_index.engage(self.game)
                                self.red_replay_step_up(redthreeodds - self.game.red_replay_counter.position)
                    ...
                    if blue_winner == 3:
                        if self.game.search_index.status == False:
                            if self.game.green_replay_counter.position < greenfiveodds:
                                self.game.search_index.engage(self.game)
                                self.green_replay_step_up(greenfiveodds - self.game.green_replay_counter.position)
            if relays == 4 or red_winner == 4 or yellow_winner == 4 or green_winner == 4 or red_ss_winner == 4 or yellow_ss_winner == 4 or big_green_winner == 4 or small_green_winner == 4 or top_red_winner == 4 or bottom_yellow_winner == 4 or big_red_winner == 4:
                    if red_ss_winner == 4:
                        if self.game.search_index.status == False:
                            if self.game.red_super_section.status == True:
                        ...
                        if self.game.search_index.status == False:
                            if self.game.yellow_super_section.status == True:
                                ...
                                if self.game.yellow_replay_counter.position < yellowfourodds:
                                    self.game.search_index.engage(self.game)
                                    self.yellow_replay_step_up(yellowfourodds - self.game.yellow_replay_counter.position)
                    if (red == 1 and relays == 4) or top_red_winner == 4 or big_red_winner == 4:
                        if self.game.search_index.status == False:
                            if self.game.red_replay_counter.position < redfourodds:
                                self.game.search_index.engage(self.game)
                                self.red_replay_step_up(redfourodds - self.game.red_replay_counter.position)
            ...
            if relays == 5 or red_winner == 5 or yellow_winner == 5 or green_winner == 5 or red_ss_winner == 5 or yellow_ss_winner == 5 or big_green_winner == 5 or small_green_winner == 5 or top_red_winner == 5 or bottom_yellow_winner == 5 or big_red_winner == 5:
                if (red == 1 and relays == 5) or red_ss_winner == 5 or top_red_winner == 5 or big_red_winner == 5:
                    if self.game.search_index.status == False:
                        if self.game.red_replay_counter.position < redfiveodds:
                            self.game.search_index.engage(self.game)
                            self.red_replay_step_up(redfiveodds - self.game.red_replay_counter.position)
        ...
        if self.game.cu == 1:
            ...
            if self.game.cu:
                ...
                if i == 1:
                    ...
                    return 0
            elif self.game.before_fifth.status == False:
                i = self.check_mixer2()
                if i == 1:
                    return 1
                else:
                    return 0
            elif self.game.after_fifth.status == False:
                i = self.check_mixer2()
                if i == 1:
                    return 1
                else:
    ...
    def check_mixer2(self):
        ...
        if mix2 == 19 or mix2 == 9 or mix2 == 4 or mix2 == 2 or mix2 == 10:
            return 1
        if mix2 == 21:
            return 1
    ...
    def features_spotting(self):
        ...
        if self.game.magic_screen_feature.position == 4 or self.game.magic_screen_feature.position == 6 or self.game.magic_screen_feature.position == 8 or self.game.magic_screen_feature.position == 10:
            #SUPER SECTIONS!
        ...
        #1-7 Feature
        if sd == 1 or sd == 5 or sd == 20 or sd == 28 or sd == 39 or sd == 42 or sd == 43 or sd == 49:
            self.game.one_seven_feature.engage(self.game)
        ...
        if sd == 32:
            if self.game.magic_screen_feature.position > 0 or self.game.one_seven_feature.status == False:
        ...
        if sd == 5 or sd == 6:
            if ms < 4:
                if self.game.magic_screen_feature.position < 8:
                    self.step_magic_screen(4 - ms)
                elif self.game.cu == 1:
                    self.step_magic_screen(4 - ms)
            elif ms >= 4 and ms < 5:
                if self.game.magic_screen_feature.position < 8:
                    self.step_magic_screen(6 - ms)
                elif self.game.cu == 1:
                    self.step_magic_screen(6 - ms)
            elif ms >= 6 and ms < 7:
                if self.game.magic_screen_feature.position < 8:
        ...
        if sd == 2 or sd == 10 or sd == 16 or sd == 26 or sd == 30 or sd == 38 or sd == 48:
            if self.game.magic_screen_feature.position < 10:
                self.step_magic_screen(4 - ms)
            elif self.game.cu == 1:
                self.step_magic_screen(4 - ms)
        if ms < 7:
        ...
        if self.game.magic_screen_feature.position >= 4:
    ...
    def animate_odds_scan(self, s):
        if s > 1:
            self.delay(name="odds_animation", delay=0.1, handler=graphics.ballerina.odds_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.ballerina.display, param=self)
            s -= 1
    ...
    def animate_feature_scan(self, s):
        if s > 1:
            self.delay(name="feature_animation", delay=0.1, handler=graphics.ballerina.feature_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.ballerina.display, param=self)
            s -= 1
    ...
    def animate_eb_scan(self, s):
        if s > 1:
            self.delay(name="eb_animation", delay=0.1, handler=graphics.ballerina.eb_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.ballerina.display, param=self)
            s -= 1
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [167,257]
            image = pygame.image.load('ballerina/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [241,290]
            image = pygame.image.load('ballerina/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [346,298]
            image = pygame.image.load('ballerina/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
        if title4 == 1:
            pos = [431,264]
            image = pygame.image.load('ballerina/assets/title4_on.png').convert_alpha()
            screen.blit(image, pos)
...
class Ballerina(procgame.game.BasicGame):
    """ Palm Beach was the first game with Super Cards """
    def __init__(self, machine_type):
        super(Ballerina, self).__init__(machine_type)
        ...
        #Odds steppers
        self.red_odds = units.Stepper("red_odds", 8, 'ballerina')
        self.yellow_odds = units.Stepper("yellow_odds", 8, 'ballerina')
        self.green_odds = units.Stepper("green_odds", 8, 'ballerina')
        ...
        self.one_seven_feature = units.Relay("one_seven_feature")
        self.one_seven = units.Relay("one_seven")
        self.seven_one = units.Relay("seven_one")
        ...
        self.magic_screen_feature = units.Stepper("magic_screen_feature", 12)
...
game = Ballerina(machine_type='pdb')
game.reset()
game.run_loop()
