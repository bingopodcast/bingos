...
from bingo_emulator.graphics.leader import *
...
class MulticardBingo(procgame.game.Mode):
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh leader")
...
class Leader(procgame.game.BasicGame):
    ...
    def __init__(self, machine_type):
        ...
        #Third on 17 extra coins.  This is based on Dennis Dodel's Leader,
