...
#        self.cancel_delayed(name="blink_title")
    ...
    def check_blue_features(self):
        ...
        if sd == 9 or sd == 37 or sd == 45 or sd == 2 or sd == 40 or sd == 41 or sd == 49:
    ...
    def features_spotting(self):
        ...
        if sd == 23:
            if self.game.cu:
                ...
                self.game.four_stars.engage(self.game)
        if sd == 4 or sd == 30 or sd == 32 or sd == 36:
        ...
        if self.game.selection_feature.position < 1:
            ...
            if self.game.selection_feature.position == 1 or self.game.selection_feature.position == 2:
                if sd == 4 or sd == 9 or sd == 23 or sd == 32 or sd == 37:
    ...
    def animate_odds_scan(self, s):
        if s > 1:
            self.delay(name="odds_animation", delay=0.1, handler=graphics.acapulco.odds_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.acapulco.display, param=self)
            s -= 1
    ...
    def animate_feature_scan(self, s):
        if s > 1:
            self.delay(name="feature_animation", delay=0.1, handler=graphics.acapulco.feature_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.acapulco.display, param=self)
            s -= 1
    ...
    def animate_eb_scan(self, s):
        if s > 1:
            self.delay(name="eb_animation", delay=0.1, handler=graphics.acapulco.eb_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.acapulco.display, param=self)
            s -= 1
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [167,257]
            image = pygame.image.load('acapulco/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [241,290]
            image = pygame.image.load('acapulco/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [346,298]
            image = pygame.image.load('acapulco/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
        if title4 == 1:
            pos = [431,264]
            image = pygame.image.load('acapulco/assets/title4_on.png').convert_alpha()
            screen.blit(image, pos)
