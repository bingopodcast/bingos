...
class MulticardBingo(procgame.game.Mode):
    ...
    def check_card(self):
        ...
        if self.game.reflex.connected_rivet(5) == 5:
            if pos == 7 or pos == 6 or pos == 5 or pos == 4 or pos == 2 or pos == 1:
                return 1
        elif  self.game.reflex.connected_rivet(5) == 4:
            if pos == 6 or pos == 5 or pos == 4 or pos == 2 or pos == 1:
                return 1
        elif self.game.reflex.connected_rivet(5) == 3:
            if pos == 5 or pos == 4 or pos == 2 or pos == 1:
                return 1
        elif self.game.reflex.connected_rivet(5) == 2:
            if pos == 4 or pos == 2 or pos == 1:
                return  1
...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [2,450]
            image = pygame.image.load('lite_a_line/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [126,460]
            image = pygame.image.load('lite_a_line/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
...
class LiteALine(procgame.game.BasicGame):
    ...
    def __init__(self, machine_type):
        ...
        self.card_sel_motor = units.Spotting("card_sel_motor", 7)
