...
class MulticardBingo(procgame.game.Mode):
    ...
    def animate_magic(self):
        ...
        #self.delay(name="display", delay=0, handler=graphics.nashville.display, param=self)
...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [61,251]
            image = pygame.image.load('nashville/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [218,251]
            image = pygame.image.load('nashville/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [406,252]
            image = pygame.image.load('nashville/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
        if title4 == 1:
            pos = [529,266]
            image = pygame.image.load('nashville/assets/title4_on.png').convert_alpha()
            screen.blit(image, pos)
...
class Nashville(procgame.game.BasicGame):
    ...
    def __init__(self, machine_type):
        ...
        #Magic Number stuff
        self.magic = []
        self.magic_motor = units.Motor("magic_motor", 5)
