...
from bingo_emulator.graphics.nashville import *
...
class MulticardBingo(procgame.game.Mode):
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh nashville")
        else:
            if self.game.ball_count.position >= 4:
                self.game.sound.stop_music()
    ...
    def sw_replayReset_active(self, sw):
        ...
        self.holes = []
        graphics.nashville.display(self, 0)
        self.tilt_actions()
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.nashville.reel1, graphics.nashville.reel10, graphics.nashville.reel100, graphics.nashville.reel1000)
                self.game.coils.registerDown.pulse()
                number -= 1
                graphics.nashville.display(self)
    ...
    def replay_step_up(self):
        if self.game.replays < 8999:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.nashville.reel1, graphics.nashville.reel10, graphics.nashville.reel100, graphics.nashville.reel1000)
            ...
            if self.game.switches.left.is_inactive() and self.game.switches.right.is_inactive():
                if i[0] == 1 and self.game.card1_replay_counter.position > 0:
                    ...
                    if i[0] == 1 and self.game.card1_missed.status == True:
                        ...
                        graphics.nashville.blink_double(self)
...
class Nashville(procgame.game.BasicGame):
    """ Nashville was the first game with the Magic Number """
    def __init__(self, machine_type):
        super(Nashville, self).__init__(machine_type)
        ...
        self.selector = units.Stepper("selector", 10)
...
game = Nashville(machine_type='pdb')
game.reset()
game.run_loop()
