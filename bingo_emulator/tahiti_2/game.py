...
class SinglecardBingo(procgame.game.Mode):
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.tahiti_2.reel1, graphics.tahiti_2.reel10, graphics.tahiti_2.reel100, graphics.tahiti_2.reel1000)
    ...
    def replay_step_up(self):
        if self.game.replays < 8999:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.tahiti_2.reel1, graphics.tahiti_2.reel10, graphics.tahiti_2.reel100, graphics.tahiti_2.reel1000)
    ...
    def animate_line1(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.tahiti_2.line1_animation([self, num * -1, line])
    ...
    def animate_line2(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.tahiti_2.line2_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_line3(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.tahiti_2.line3_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.tahiti_2.both_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class Tahiti2(procgame.game.BasicGame):
    """ Tahiti has Mystic Lines and a ball return feature """
