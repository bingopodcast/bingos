...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [284,249]
            image = pygame.image.load('tropicana/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [229,275]
            image = pygame.image.load('tropicana/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [347,272]
            image = pygame.image.load('tropicana/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def check_mixer4(self):
        ...
        self.delay(name="display", delay=0, handler=graphics.tropicana.display, param=self)
        if m4 == 4 or m4 == 6 or m4 == 11 or m4 == 22 or m4 == 24 or m4 == 27 or m4 == 31 or m4 == 35 or m4 == 37 or m4 == 38 or m4 == 43 or m4 == 44 or m4 == 48:
    ...
    def animate_feature_scan(self, s):
        if s > 1:
            self.delay(name="feature_animation", delay=0.1, handler=graphics.tropicana.feature_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.tropicana.display, param=self)
            s -= 1
    ...
    def animate_eb_scan(self, s):
        if s > 1:
            self.delay(name="eb_animation", delay=0.1, handler=graphics.tropicana.eb_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.tropicana.display, param=self)
            s -= 1
...
class Tropicana(procgame.game.BasicGame):
    """ Tropicana is the second United game with a standard Bally 25 hole playfield.  It's not _exactly_ the same, but close enough. """
