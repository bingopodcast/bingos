...
class SinglecardBingo(procgame.game.Mode):
    ...
    def animate_odds_scan(self, s):
        if s > 1:
            self.delay(name="odds_animation", delay=0, handler=graphics.palm_springs.odds_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.palm_springs.display, param=self)
            s -= 1
    ...
    def animate_feature_scan(self, s):
        if s > 1:
            self.delay(name="feature_animation", delay=0.1, handler=graphics.palm_springs.feature_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.palm_springs.display, param=self)
            s -= 1
    ...
    def animate_eb_scan(self, s):
        if s > 1:
            self.delay(name="eb_animation", delay=0.1, handler=graphics.palm_springs.eb_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.palm_springs.display, param=self)
            s -= 1
