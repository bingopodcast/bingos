...
class SinglecardBingo(procgame.game.Mode):
    ...
    def check_skill_shot_reflex_relay(self):
        ...
        if ssr == 4 or ssr == 0:
            ...
            if m4 == 14 or m4 == 2 or m4 == 19 or m4 == 7:
                self.game.skill_shot_reflex_relay.engage(self.game)
        elif ssr == 2:
            if m4 == 16 or m4 == 23 or m4 == 4 or m4 == 11:
                self.game.skill_shot_reflex_relay.engage(self.game)
        elif ssr == 1:
            if m4 == 17 or m4 == 21 or m4 == 5 or m4 == 9:
                self.game.skill_shot_reflex_relay.engage(self.game)

    def select_skill_shot(self):
        self.check_skill_shot_reflex_relay()
        sd = self.game.spotting.position
        if sd == 4 or sd  ==  13 or sd == 22 or sd == 29 or sd == 38 or sd == 47:
        ...
        if sd == 1 or sd  == 10 or sd  == 16 or sd == 24 or sd == 26 or sd == 35 or sd == 41 or sd == 49:
            if self.game.cu:
                if 1 not in self.game.skill_shot_selection:
                    self.game.skill_shot_selection.append(1)
            else:
                if 9 not in self.game.skill_shot_selection:
                   self.game.skill_shot_selection.append(9)
        if sd == 14  or sd == 15 or  sd == 23 or sd == 39 or sd == 40 or sd == 48:
            if self.game.cu:
                if 7 not in self.game.skill_shot_selection:
                    self.game.skill_shot_selection.append(7)
            else:
...
#        self.cancel_delayed(name="blink_title")
    ...
    def ss_probability(self):
        ...
        if self.game.skill_shot_scores.position == 0:
            ...
            if m2 ==  2 or m2 == 5 or m2 == 6 or m2 == 20 or m2 == 13 or m2 == 19 or  m2 == 22 or  m2 == 23:
                self.game.skill_shot_scores.step()
                self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
                self.game.skill_shot_scores.step()
                self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [167,257]
            image = pygame.image.load('bounty/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [241,290]
            image = pygame.image.load('bounty/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [346,298]
            image = pygame.image.load('bounty/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
        if title4 == 1:
            pos = [431,264]
            image = pygame.image.load('bounty/assets/title4_on.png').convert_alpha()
            screen.blit(image, pos)
