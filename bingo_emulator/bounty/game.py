...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            if self.game.ball_count.position >= 4:
                self.cancel_delayed(name="blink_letter")
                graphics.bounty.blink_letter([self,1,self.game.magic_screen.position])
    ...
    def select_skill_shot(self):
        ...
        self.animate_ss_number([begin,self.game.spotting.movement_amount,1])
    ...
    def regular_play(self, red_letter=0):
        ...
        if self.game.start.status == True:
            ...
            if red_letter > 0:
                ...
                self.game.skill_shot_missed.disengage()
    ...
    def sw_gate_inactive_for_1ms(self, sw):
        ...
        if self.game.ball_count.position >= 5:
            self.game.coils.redROLamp.disable()
        if self.game.ball_count.position <= 1 and len(self.game.skill_shot_selection) == 0:
            if self.game.skill_shot_scores.position > 0:
                self.select_skill_shot()
        if self.game.ball_count.position > 1:
            self.game.skill_shot_missed.engage(self.game)
        if self.game.ball_count.position <= 7:
            self.check_lifter_status()
        self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
    ...
    def skill_shot_replay_step_up(self, number):
        ...
        if number >= 1:
            ...
            if self.game.replays == 899:
                number = 0
            self.delay(name="skill_shot_replay_step_up", delay=0.25, handler=self.skill_shot_replay_step_up, param=number)
        else:
            self.game.search_index.disengage()
            self.cancel_delayed(name="skill_shot_replay_step_up")
            self.search()
    ...
    def closed_search_relays(self, rivets):
        ...
        if self.game.magic_screen.position == 1:
            ...
            # second column
            self.pos[3] = {11:1, 22:2, 13:3, 21:4, 3:5}
            # fifth column
            self.pos[4] = {}
            ...
            # 1 column
            self.pos[7] = {2:1, 7:2, 16:3, 5:4, 14:5}
            # 4 column
            self.pos[8] = {}
        ...
        elif self.game.magic_screen.position == 7:
            # "D" Position
            self.pos[0] = {}
        ...
        if number >= 1:
            ...
            if number <= 0:
                if self.game.magic_screen_feature.position in [4,5,6,7]:
                    number = 6 - self.game.magic_screen_feature.position
            self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
    ...
    def animate_ss_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.bounty.ss_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
            self.delay(name="ss_animation", delay=0.05, handler=self.animate_ss_scan, param=args)
        else:
    ...
    def animate_odds_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.bounty.odds_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
            self.delay(name="odds_animation", delay=0.05, handler=self.animate_odds_scan, param=args)
        else:
            self.cancel_delayed(name="odds_animation")
            self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
            self.scan_odds()
    ...
    def animate_screen_right(self, args):
        ...
        num = args[1]
        if num >= 0:
            graphics.bounty.screen_animation([self, num, "right"])
            self.cancel_delayed(name="display")
            num = num - 1
    ...
    def animate_screen_left(self, args):
        ...
        num = args[1]
        if num >= 0:
            graphics.bounty.screen_animation([self, num, "left"])
            self.cancel_delayed(name="display")
            num = num - 1
    ...
    def animate_features_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.bounty.feature_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
            self.delay(name="feature_animation", delay=0.05, handler=self.animate_features_scan, param=args)
        else:
            self.cancel_delayed(name="feature_animation")
            self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
            self.scan_features()
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.bounty.both_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
            self.delay(name="both_animation", delay=0.05, handler=self.animate_both, param=args)
        else:
            self.cancel_delayed(name="both_animation")
            self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
            self.scan_all()
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.bounty.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
            self.delay(name="eb_animation", delay=0.05, handler=self.animate_eb_scan, param=args)
        else:
            self.cancel_delayed(name="eb_animation")
            self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
            self.scan_eb()

    def animate_ss_number(self, args):
        start = args[0]
        diff = args[1]
        num = args[2]
        if start + num >= 50:
        ...
        if diff >= 0:
            num = num + 1
            graphics.bounty.ss_number_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
            self.delay(name="ss_number_animation", delay=0.05, handler=self.animate_ss_number, param=args)
        else:
            self.cancel_delayed(name="ss_number_animation")
            self.delay(name="display", delay=0.1, handler=graphics.bounty.display, param=self)
...
class Bounty(procgame.game.BasicGame):
    ...
    def __init__(self, machine_type):
        ...
        self.cu = 1
        self.cam4 = units.Stepper("cam4", 3, "bounty", "continuous")
        ...
        self.skill_shot_replay_counter = units.Stepper("skill_shot_replay_counter", 120)
        self.skill_shot_missed = units.Relay("skill_shot_missed")
