...
from bingo_emulator.graphics.shoot_a_line import *
...
#        self.cancel_delayed(name="blink_title")
        graphics.shoot_a_line.display(self, 0)
        self.tilt_actions()
#        self.delay(name="blink_title", delay=1, handler=self.blink_title)
    ...
    def replay_step_up(self):
        if self.game.replays < 8999:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.shoot_a_line.reel1, graphics.shoot_a_line.reel10, graphics.shoot_a_line.reel100, graphics.shoot_a_line.reel1000)
...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [307,237]
            image = pygame.image.load('shoot_a_line/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [423,237]
            image = pygame.image.load('shoot_a_line/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
