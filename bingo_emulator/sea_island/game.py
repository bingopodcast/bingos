...
class SinglecardBingo(procgame.game.Mode):
    ...
    def step_magic_screen(self, number):
        if number >= 1:
            ...
            number -= 1
            if self.game.magic_screen_feature.position >= 4 and self.game.magic_screen_feature.position < 7:
    ...
    def animate_odds_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.sea_island.odds_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_features_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.sea_island.feature_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.sea_island.both_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_screen_right(self, args):
        ...
        num = args[1]
        if num >= 0:
            graphics.sea_island.screen_animation([self, num, "right"])
            self.cancel_delayed(name="display")
            num = num - 1
    ...
    def animate_screen_left(self, args):
        ...
        num = args[1]
        if num >= 0:
            graphics.sea_island.screen_animation([self, num, "left"])
            self.cancel_delayed(name="display")
            num = num - 1
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.sea_island.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class SeaIsland(procgame.game.BasicGame):
    """ Sea Island is one of two Magic Screen games with a position H """
    def __init__(self, machine_type):
        ...
        self.cu = 1
        self.cam4 = units.Stepper("cam4", 3, "sea_island", "continuous")
