...
from bingo_emulator.graphics.bright_spot import *
...
class MulticardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        ...
        self.regular_play()
        self.delay(name="display", delay=0.1, handler=graphics.bright_spot.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh bright_spot")
    ...
    def sw_gate_inactive_for_1ms(self, sw):
        ...
        if self.game.ball_count.position == 0:
            ...
            elif self.game.spotting.position == 5:
                self.holes.append(20)
            elif self.game.spotting.position == 8:
 ...
 #       self.cancel_delayed(name="blink_title")
        graphics.bright_spot.display(self)
        self.tilt_actions()
#        self.delay(name="blink_title", delay=1, handler=self.blink_title)
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.bright_spot.reel1, graphics.bright_spot.reel10, graphics.bright_spot.reel100)
    ...
    def replay_step_up(self):
        if self.game.replays < 899:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.bright_spot.reel1, graphics.bright_spot.reel10, graphics.bright_spot.reel100)
...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def find_winner(self, relays, card):
        if self.game.search_index.status == False and self.game.replays < 899:
            if card == 1:
                ...
                if relays == 4:
                    if self.game.card1_replay_counter.position < 24:
                        self.game.search_index.engage(self.game)
                        self.card1_replay_step_up(24 - self.game.card1_replay_counter.position)
                if relays == 5:
            ...
            if card == 2:
                ...
                if relays == 4:
                    if self.game.card2_replay_counter.position < 24:
                        self.game.search_index.engage(self.game)
                        self.card2_replay_step_up(24 - self.game.card2_replay_counter.position)
                if relays == 5:
            ...
            if card == 3:
                ...
                if relays == 4:
                    if self.game.card3_replay_counter.position < 24:
                        self.game.search_index.engage(self.game)
                        self.card3_replay_step_up(24 - self.game.card3_replay_counter.position)
                if relays == 5:
            ...
            if card == 4:
                ...
                if relays == 4:
                    if self.game.card4_replay_counter.position < 24:
                        self.game.search_index.engage(self.game)
                        self.card4_replay_step_up(24 - self.game.card4_replay_counter.position)
                if relays == 5:
            ...
            if card == 5:
                ...
                if relays == 4:
                    if self.game.card5_replay_counter.position < 24:
                        self.game.search_index.engage(self.game)
                        self.card5_replay_step_up(24 - self.game.card5_replay_counter.position)
                if relays == 5:
            ...
            if card == 6:
                ...
                if relays == 4:
                    if self.game.card6_replay_counter.position < 24:
                        self.game.search_index.engage(self.game)
                        self.card6_replay_step_up(24 - self.game.card6_replay_counter.position)
                if relays == 5:
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [182,299]
            image = pygame.image.load('bright_spot/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [246,298]
            image = pygame.image.load('bright_spot/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [294,298]
            image = pygame.image.load('bright_spot/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
        if title4 == 1:
            pos = [381,298]
            image = pygame.image.load('bright_spot/assets/title4_on.png').convert_alpha()
            screen.blit(image, pos)
        if title5 == 1:
            pos = [449,298]
            image = pygame.image.load('bright_spot/assets/title5_on.png').convert_alpha()
            screen.blit(image, pos)
...
class BrightSpot(procgame.game.BasicGame):
    """ Bright Lights was the first bingo produced by Bally """
    def __init__(self, machine_type):
        super(BrightSpot, self).__init__(machine_type)
        ...
        self.spotting = units.Stepper("spotting", 10, 'bright_spot', 'continuous')
...
game = BrightSpot(machine_type='pdb')
game.reset()
game.run_loop()
