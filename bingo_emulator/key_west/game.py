...
class SinglecardBingo(procgame.game.Mode):
    ...
    def scan_odds(self):
        ...
        if self.game.yellow_odds.position >= 2 and self.game.red_odds.position >= 2 and self.game.green_odds.position >= 2:
            ...
            if p == 1:
                m3 = self.check_odds_mixer3("yellow")
                if m3 == 1:
                    es = self.check_extra_step()
                    if es == 1:
                        i = random.randint(1,3)
            ...
            if p == 1:
                m3 = self.check_odds_mixer3("green")
                if m3 == 1:
                    es = self.check_extra_step()
                    if es == 1:
                        i = random.randint(1,3)
    ...
    def check_odds_mixer3(self, color):
        if color == "yellow":
            if self.game.mixer3.position in [2,5,15,20]:
                return 1
            else:
                return 0
        if color == "red":
            if self.game.mixer3.position in [3,10,16,19,21]:
                return 1
            else:
                return 0
        if color == "green":
            if self.game.mixer3.position in [0,6,7,8,9,11,12,14,18,22]:
                return 1
            else:
                return 0
    ...
    def features_spotting(self):
        ...
        if sd == 17:
            if self.game.ballyhole.status == False:
                ...
                self.game.sound.play('tilt')
        if sd == 44:
            if self.game.select_a_score.status == False:
                self.game.select_a_score.engage(self.game)
                self.game.sound.play('tilt')
        if sd in [2,10,19,22,24,42]:
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.key_west.both_animation([self, start + num])
    ...
    def animate_squarea(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.key_west.squarea_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_squareb(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.key_west.squareb_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squarec(self, args):
        ...
        square = args[2]
        if num < 62:
            graphics.key_west.squarec_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squared(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.key_west.squared_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.key_west.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class KeyWest(procgame.game.BasicGame):
    """ Key West was the only game with select-a-score """
