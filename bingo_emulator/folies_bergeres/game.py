...
from bingo_emulator.graphics.folies_bergeres import *
...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        if self.game.start.status == True:
            ...
            self.game.features.disengage()
            self.regular_play()
        self.delay(name="display", delay=0.1, handler=graphics.folies_bergeres.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh folies_bergeres")
        else:
    ...
    def regular_play(self, red_letter=0):
        ...
        if self.game.start.status == True:
            ...
            graphics.folies_bergeres.display(self)
            self.check_lifter_status()
        else:
            if red_letter > 0:
                if self.game.switches.shutter.is_inactive():
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.folies_bergeres.reel1, graphics.folies_bergeres.reel10, graphics.folies_bergeres.reel100, graphics.folies_bergeres.reel1000)
                self.game.coils.registerDown.pulse()
                number -= 1
                self.delay(name="display", delay=0, handler=graphics.folies_bergeres.display, param=self)
    ...
    def replay_step_up(self):
        if self.game.replays < 8999:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.folies_bergeres.reel1, graphics.folies_bergeres.reel10, graphics.folies_bergeres.reel100, graphics.folies_bergeres.reel1000)
    ...
    def animate_odds_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.folies_bergeres.odds_animation([self, start + num])
    ...
    def animate_line1(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.folies_bergeres.line1_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_line2(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.folies_bergeres.line2_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_line3(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.folies_bergeres.line3_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_features_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.folies_bergeres.feature_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.folies_bergeres.both_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.folies_bergeres.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class FoliesBergeres(procgame.game.BasicGame):
    """ Folies Bergeres is a rehash of Beauty Beach """
    def __init__(self, machine_type):
        super(FoliesBergeres, self).__init__(machine_type)
        ...
        #Odds steppers
        self.red_odds = units.Stepper("red_odds", 8, 'folies_bergeres')
        self.yellow_odds = units.Stepper("yellow_odds", 8, 'folies_bergeres')
        self.green_odds = units.Stepper("green_odds", 8, 'folies_bergeres')
        self.blue_odds = units.Stepper("blue_odds", 8, 'folies_bergeres')
        ...
        self.line1 = units.Stepper("line1", 3, "folies_bergeres", "continuous")
        self.line2 = units.Stepper("line2", 1, "folies_bergeres", "continuous")
        self.line3 = units.Stepper("line3", 1, "folies_bergeres", "continuous")
    ...
    def reset(self):
        super(FoliesBergeres, self).reset()
...
game = FoliesBergeres(machine_type='pdb')
game.reset()
game.run_loop()
