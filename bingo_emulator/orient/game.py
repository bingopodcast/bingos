...
from bingo_emulator.graphics.orient import *
...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        if self.game.start.status == True:
            ...
            self.regular_play()
        self.delay(name="display", delay=0.1, handler=graphics.orient.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh orient")
        else:
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.orient.reel1, graphics.orient.reel10, graphics.orient.reel100, graphics.orient.reel1000)
                self.game.coils.registerDown.pulse()
                number -= 1
                self.delay(name="display", delay=0, handler=graphics.orient.display, param=self)
    ...
    def replay_step_up(self):
        if self.game.replays < 8999:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.orient.reel1, graphics.orient.reel10, graphics.orient.reel100, graphics.orient.reel1000)
        ...
        if self.game.special_odds.position < 2:
            ...
            if r == 1:
                if self.game.special_odds.position in [2,3,4,5]:
                    if m5 in [5,18]:
                        self.game.special_odds.step()
                if self.game.special_odds.position in [6, 7]:
    ...
    def animate_special(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.orient.special_animation([self, start + num])
    ...
    def animate_line1(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.orient.line1_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_line2(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.orient.line2_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_line3(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.orient.line3_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_odds_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.orient.odds_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_features_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.orient.feature_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.orient.both_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.orient.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class Orient(procgame.game.BasicGame):
    """ Orient was the first hybrid solid state game """
    def __init__(self, machine_type):
        super(Orient, self).__init__(machine_type)
        ...
        #Odds steppers
        self.red_odds = units.Stepper("red_odds", 10, 'orient')
        self.yellow_odds = units.Stepper("yellow_odds", 10, 'orient')
        self.green_odds = units.Stepper("green_odds", 10, 'orient')
        self.blue_odds = units.Stepper("blue_odds", 10, 'orient')
        ...
        self.line1 = units.Stepper("line1", 3, "orient", "continuous")
        self.line2 = units.Stepper("line2", 1, "orient", "continuous")
        self.line3 = units.Stepper("line3", 1, "orient", "continuous")
        ...
        self.special_odds = units.Stepper("special_odds", 8, 'orient')
