...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('lido/assets/lido_menu.png').convert_alpha()
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('lido/assets/lido_gi.png').convert_alpha()
        else:
            backglass = pygame.image.load('lido/assets/lido_off.png').convert_alpha()
