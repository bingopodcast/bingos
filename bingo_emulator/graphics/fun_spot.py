...
bg_menu = pygame.image.load('fun_spot/assets/fun_spot_menu.png')
bg_gi = pygame.image.load('fun_spot/assets/fun_spot_gi.png')
bg_off = pygame.image.load('fun_spot/assets/fun_spot_off.png')
