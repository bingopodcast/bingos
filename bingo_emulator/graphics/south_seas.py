...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('south_seas/assets/south_seas_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('south_seas/assets/south_seas_gi.png')
        else:
            backglass = pygame.image.load('south_seas/assets/south_seas_off.png')
