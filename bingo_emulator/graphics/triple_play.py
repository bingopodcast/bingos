...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('triple_play/assets/triple_play_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('triple_play/assets/triple_play_gi.png')
        else:
            backglass = pygame.image.load('triple_play/assets/triple_play_off.png')
