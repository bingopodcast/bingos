...
card1_display = pygame.image.load('zingo/assets/card1.png').convert_alpha()
card2_display = pygame.image.load('zingo/assets/card2.png').convert_alpha()
card3_display = pygame.image.load('zingo/assets/card3.png').convert_alpha()
number1 = pygame.image.load('zingo/assets/number1.png').convert_alpha()
number2 = pygame.image.load('zingo/assets/number2.png').convert_alpha()
number3 = pygame.image.load('zingo/assets/number3.png').convert_alpha()
r100 = pygame.image.load('zingo/assets/100.png').convert_alpha()
r200 = pygame.image.load('zingo/assets/200.png').convert_alpha()
r300 = pygame.image.load('zingo/assets/300.png').convert_alpha()
r400 = pygame.image.load('zingo/assets/400.png').convert_alpha()
r10 = pygame.image.load('zingo/assets/10.png').convert_alpha()
r20 = pygame.image.load('zingo/assets/20.png').convert_alpha()
r30 = pygame.image.load('zingo/assets/30.png').convert_alpha()
r40 = pygame.image.load('zingo/assets/40.png').convert_alpha()
r50 = pygame.image.load('zingo/assets/50.png').convert_alpha()
r60 = pygame.image.load('zingo/assets/60.png').convert_alpha()
r70 = pygame.image.load('zingo/assets/70.png').convert_alpha()
r80 = pygame.image.load('zingo/assets/80.png').convert_alpha()
r90 = pygame.image.load('zingo/assets/90.png').convert_alpha()
r1 = pygame.image.load('zingo/assets/1.png').convert_alpha()
r2 = pygame.image.load('zingo/assets/2.png').convert_alpha()
r3 = pygame.image.load('zingo/assets/3.png').convert_alpha()
r4 = pygame.image.load('zingo/assets/4.png').convert_alpha()
r5 = pygame.image.load('zingo/assets/5.png').convert_alpha()
r6 = pygame.image.load('zingo/assets/6.png').convert_alpha()
r7 = pygame.image.load('zingo/assets/7.png').convert_alpha()
