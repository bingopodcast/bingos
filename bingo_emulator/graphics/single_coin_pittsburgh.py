...
card = pygame.image.load('single_coin_pittsburgh/assets/card.png').convert_alpha()
number = pygame.image.load('single_coin_pittsburgh/assets/number.png').convert_alpha()
tilt = pygame.image.load('single_coin_pittsburgh/assets/tilt.png').convert_alpha()
r10000 = pygame.image.load('single_coin_pittsburgh/assets/10000.png').convert_alpha()
r20000 = pygame.image.load('single_coin_pittsburgh/assets/20000.png').convert_alpha()
r1000 = pygame.image.load('single_coin_pittsburgh/assets/1000.png').convert_alpha()
r2000 = pygame.image.load('single_coin_pittsburgh/assets/2000.png').convert_alpha()
r3000 = pygame.image.load('single_coin_pittsburgh/assets/3000.png').convert_alpha()
r4000 = pygame.image.load('single_coin_pittsburgh/assets/4000.png').convert_alpha()
r5000 = pygame.image.load('single_coin_pittsburgh/assets/5000.png').convert_alpha()
r6000 = pygame.image.load('single_coin_pittsburgh/assets/6000.png').convert_alpha()
r7000 = pygame.image.load('single_coin_pittsburgh/assets/7000.png').convert_alpha()
r8000 = pygame.image.load('single_coin_pittsburgh/assets/8000.png').convert_alpha()
r9000 = pygame.image.load('single_coin_pittsburgh/assets/9000.png').convert_alpha()
r100 = pygame.image.load('single_coin_pittsburgh/assets/100.png').convert_alpha()
r200 = pygame.image.load('single_coin_pittsburgh/assets/200.png').convert_alpha()
r300 = pygame.image.load('single_coin_pittsburgh/assets/300.png').convert_alpha()
r400 = pygame.image.load('single_coin_pittsburgh/assets/400.png').convert_alpha()
r500 = pygame.image.load('single_coin_pittsburgh/assets/500.png').convert_alpha()
r600 = pygame.image.load('single_coin_pittsburgh/assets/600.png').convert_alpha()
r700 = pygame.image.load('single_coin_pittsburgh/assets/700.png').convert_alpha()
r800 = pygame.image.load('single_coin_pittsburgh/assets/800.png').convert_alpha()
r900 = pygame.image.load('single_coin_pittsburgh/assets/900.png').convert_alpha()
...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('single_coin_pittsburgh/assets/single_coin_pittsburgh_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('single_coin_pittsburgh/assets/single_coin_pittsburgh_gi.png')
        else:
            backglass = pygame.image.load('single_coin_pittsburgh/assets/single_coin_pittsburgh_off.png')
    backglass = pygame.transform.scale(backglass, (720, 1280))
    
    screen.blit(backglass, backglass_position)

    if s.game.selector.position >= 1:
        card1_position = [85,765]
