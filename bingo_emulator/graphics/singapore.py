...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('singapore/assets/singapore_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('singapore/assets/singapore_gi.png')
        else:
            backglass = pygame.image.load('singapore/assets/singapore_off.png')
