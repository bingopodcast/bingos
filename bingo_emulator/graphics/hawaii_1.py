...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('hawaii_1/assets/hawaii_1_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('hawaii_1/assets/hawaii_1_gi.png')
        else:
            backglass = pygame.image.load('hawaii_1/assets/hawaii_1_off.png')
