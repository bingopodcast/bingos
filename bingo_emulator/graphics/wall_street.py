...
bg_menu = pygame.image.load('wall_street/assets/wall_street_menu.png')
bg_gi = pygame.image.load('wall_street/assets/wall_street_gi.png')
bg_off = pygame.image.load('wall_street/assets/wall_street_off.png')
...
def blink_double(s):
    ...
    if s.game.blink == 1:
        ...
        dirty_rects.append(screen.blit(bg_gi, (505,656), pygame.Rect(505,656,162,108)))
        pygame.display.update(dirty_rects)
