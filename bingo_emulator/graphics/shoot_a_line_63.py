...
card = pygame.image.load('shoot_a_line_63/assets/card.png').convert_alpha()
number = pygame.image.load('shoot_a_line_63/assets/number.png').convert_alpha()
tilt = pygame.image.load('shoot_a_line_63/assets/tilt.png').convert_alpha()
...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('shoot_a_line_63/assets/shoot_a_line_63_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('shoot_a_line_63/assets/shoot_a_line_63_gi.png')
        else:
            backglass = pygame.image.load('shoot_a_line_63/assets/shoot_a_line_63_off.png')
