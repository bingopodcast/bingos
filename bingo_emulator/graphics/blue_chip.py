...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('blue_chip/assets/blue_chip_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('blue_chip/assets/blue_chip_gi.png')
        else:
            backglass = pygame.image.load('blue_chip/assets/blue_chip_off.png')
