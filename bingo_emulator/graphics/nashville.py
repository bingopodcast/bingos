...
bg_menu = pygame.image.load('nashville/assets/nashville_menu.png')
bg_gi = pygame.image.load('nashville/assets/nashville_gi.png')
bg_off = pygame.image.load('nashville/assets/nashville_off.png')
...
def blink_double(s):
    ...
    if s.game.blink == 1:
        ...
        dirty_rects.append(screen.blit(bg_gi, (361,640), pygame.Rect(361,640,146,97)))
        pygame.display.update(dirty_rects)
