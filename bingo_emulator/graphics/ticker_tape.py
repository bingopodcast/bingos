...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('ticker_tape/assets/ticker_tape_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('ticker_tape/assets/ticker_tape_gi.png')
        else:
            backglass = pygame.image.load('ticker_tape/assets/ticker_tape_off.png')
