...
bg_menu = pygame.image.load('bright_spot/assets/bright_spot_menu.png')
bg_gi = pygame.image.load('bright_spot/assets/bright_spot_gi.png')
bg_off = pygame.image.load('bright_spot/assets/bright_spot_off.png')
