...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('can_can/assets/can_can_menu.png').convert_alpha()
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('can_can/assets/can_can_gi.png').convert_alpha()
        else:
            backglass = pygame.image.load('can_can/assets/can_can_off.png').convert_alpha()
