...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('barrel_o_fun_61/assets/barrel_o_fun_61_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('barrel_o_fun_61/assets/barrel_o_fun_61_gi.png')
        else:
            backglass = pygame.image.load('barrel_o_fun_61/assets/barrel_o_fun_61_off.png')
