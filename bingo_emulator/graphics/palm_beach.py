...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('palm_beach/assets/palm_beach_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('palm_beach/assets/palm_beach_gi.png')
        else:
            backglass = pygame.image.load('palm_beach/assets/palm_beach_off.png')
