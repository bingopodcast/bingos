...
bg_menu = pygame.image.load('crosswords/assets/crosswords_menu.png')
bg_gi = pygame.image.load('crosswords/assets/crosswords_gi.png')
bg_off = pygame.image.load('crosswords/assets/crosswords_off.png')
