...
def line1_animation(args):
    ...
    if line == 1:
        ...
        dirty_rects.append(screen.blit(bg_gi, (22,196), pygame.Rect(22,196,337,107)))
...
def line2_animation(args):
    ...
    if line == 2:
        ...
        dirty_rects.append(screen.blit(number_card, nc_p))
        if (s.game.anti_cheat.status == True):
            dirty_rects.append(screen.blit(bg_gi, (228,369), pygame.Rect(228,369,270,212)))
        else:
            dirty_rects.append(screen.blit(bg_off, (228,369), pygame.Rect(228,369,270,212)))
