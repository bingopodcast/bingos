...
bg_menu = pygame.image.load('leader/assets/leader_menu.png')
bg_gi = pygame.image.load('leader/assets/leader_gi.png')
bg_off = pygame.image.load('leader/assets/leader_off.png')
