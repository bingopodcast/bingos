...
card1 = pygame.image.load('leader/assets/card1.png').convert_alpha()
card2 = pygame.image.load('leader/assets/card2.png').convert_alpha()
card3 = pygame.image.load('leader/assets/card3.png').convert_alpha()
balls5_display = pygame.image.load('leader/assets/5_balls.png').convert_alpha()
balls6_display = pygame.image.load('leader/assets/6_balls.png').convert_alpha()
balls7_display = pygame.image.load('leader/assets/7_balls.png').convert_alpha()
balls8_display = pygame.image.load('leader/assets/8_balls.png').convert_alpha()
number1 = pygame.image.load('leader/assets/number1.png').convert_alpha()
number2 = pygame.image.load('leader/assets/number2.png').convert_alpha()
number3 = pygame.image.load('leader/assets/number3.png').convert_alpha()
tilt = pygame.image.load('leader/assets/tilt.png').convert_alpha()
r100 = pygame.image.load('leader/assets/100.png').convert_alpha()
r200 = pygame.image.load('leader/assets/200.png').convert_alpha()
r300 = pygame.image.load('leader/assets/300.png').convert_alpha()
r400 = pygame.image.load('leader/assets/400.png').convert_alpha()
r10 = pygame.image.load('leader/assets/10.png').convert_alpha()
r20 = pygame.image.load('leader/assets/20.png').convert_alpha()
r30 = pygame.image.load('leader/assets/30.png').convert_alpha()
r40 = pygame.image.load('leader/assets/40.png').convert_alpha()
r50 = pygame.image.load('leader/assets/50.png').convert_alpha()
r60 = pygame.image.load('leader/assets/60.png').convert_alpha()
r70 = pygame.image.load('leader/assets/70.png').convert_alpha()
r80 = pygame.image.load('leader/assets/80.png').convert_alpha()
r90 = pygame.image.load('leader/assets/90.png').convert_alpha()
r1 = pygame.image.load('leader/assets/1.png').convert_alpha()
r2 = pygame.image.load('leader/assets/2.png').convert_alpha()
r3 = pygame.image.load('leader/assets/3.png').convert_alpha()
r4 = pygame.image.load('leader/assets/4.png').convert_alpha()
r5 = pygame.image.load('leader/assets/5.png').convert_alpha()
r6 = pygame.image.load('leader/assets/6.png').convert_alpha()
r7 = pygame.image.load('leader/assets/7.png').convert_alpha()
r8 = pygame.image.load('leader/assets/8.png').convert_alpha()
r9 = pygame.image.load('leader/assets/9.png').convert_alpha()
...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('leader/assets/leader_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('leader/assets/leader_gi.png')
        else:
            backglass = pygame.image.load('leader/assets/leader_off.png')
