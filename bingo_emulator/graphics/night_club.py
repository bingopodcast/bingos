...
def display(s, replays=0, menu=False):
    ...
    if menu == True:
        backglass = pygame.image.load('night_club/assets/night_club_menu.png')
    else:
        if (s.game.anti_cheat.status == True):
            backglass = pygame.image.load('night_club/assets/night_club_gi.png')
        else:
            backglass = pygame.image.load('night_club/assets/night_club_off.png')
