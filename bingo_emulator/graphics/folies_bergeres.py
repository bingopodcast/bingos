...
odds = pygame.image.load('folies_bergeres/assets/odds.png').convert_alpha()
eb = pygame.image.load('folies_bergeres/assets/eb.png').convert_alpha()
eb_number = pygame.image.load('folies_bergeres/assets/eb_number.png').convert_alpha()
extra_balls = pygame.image.load('folies_bergeres/assets/extra_balls.png').convert_alpha()
time = pygame.image.load('folies_bergeres/assets/time.png').convert_alpha()
ml_letter = pygame.image.load('folies_bergeres/assets/ml_letter.png').convert_alpha()
ml_arrow = pygame.image.load('folies_bergeres/assets/ml_arrow.png').convert_alpha()
ml_a = pygame.image.load('folies_bergeres/assets/ml_a.png').convert_alpha()
ml_b = pygame.image.load('folies_bergeres/assets/ml_b.png').convert_alpha()
ml_c = pygame.image.load('folies_bergeres/assets/ml_c.png').convert_alpha()
select_now = pygame.image.load('folies_bergeres/assets/select_now.png').convert_alpha()
tilt = pygame.image.load('folies_bergeres/assets/tilt.png').convert_alpha()
button = pygame.image.load('folies_bergeres/assets/pap.png').convert_alpha()
red_double = pygame.image.load('folies_bergeres/assets/red_double.png').convert_alpha()
green_double = pygame.image.load('folies_bergeres/assets/green_double.png').convert_alpha()
yellow_double = pygame.image.load('folies_bergeres/assets/yellow_double.png').convert_alpha()
blue_double = pygame.image.load('folies_bergeres/assets/blue_double.png').convert_alpha()
four_stars = pygame.image.load('folies_bergeres/assets/four_stars.png').convert_alpha()
six_stars = pygame.image.load('folies_bergeres/assets/six_stars.png').convert_alpha()
three_stars = pygame.image.load('folies_bergeres/assets/three_stars.png').convert_alpha()
three_red = pygame.image.load('folies_bergeres/assets/three_red.png').convert_alpha()
two_red = pygame.image.load('folies_bergeres/assets/two_red.png').convert_alpha()
red_letter = pygame.image.load('folies_bergeres/assets/red_letter.png').convert_alpha()
letter1 = pygame.image.load('folies_bergeres/assets/letter1.png').convert_alpha()
letter2 = pygame.image.load('folies_bergeres/assets/letter2.png').convert_alpha()
letter3 = pygame.image.load('folies_bergeres/assets/letter3.png').convert_alpha()
letter4 = pygame.image.load('folies_bergeres/assets/letter4.png').convert_alpha()
letter5 = pygame.image.load('folies_bergeres/assets/letter5.png').convert_alpha()
letter6 = pygame.image.load('folies_bergeres/assets/letter6.png').convert_alpha()
red_letter1 = pygame.image.load('folies_bergeres/assets/red_letter1.png').convert_alpha()
red_letter2 = pygame.image.load('folies_bergeres/assets/red_letter2.png').convert_alpha()
red_letter3 = pygame.image.load('folies_bergeres/assets/red_letter3.png').convert_alpha()
red_letter4 = pygame.image.load('folies_bergeres/assets/red_letter4.png').convert_alpha()
red_letter5 = pygame.image.load('folies_bergeres/assets/red_letter5.png').convert_alpha()
red_letter6 = pygame.image.load('folies_bergeres/assets/red_letter6.png').convert_alpha()
number_card = pygame.image.load('folies_bergeres/assets/number_card.png').convert_alpha()
number = pygame.image.load('folies_bergeres/assets/number.png').convert_alpha()
columnb1 = pygame.image.load('folies_bergeres/assets/columnb1.png').convert_alpha()
columnb2 = pygame.image.load('folies_bergeres/assets/columnb2.png').convert_alpha()
columna = pygame.image.load('folies_bergeres/assets/columna.png').convert_alpha()
...
def display(s, replays=0, menu=False):
    ...
    if s.game.extra_ball.position >= 1:
        eb_position = [147,1036]
        screen.blit(eb_number, eb_position)
    if s.game.extra_ball.position >= 2:
        eb_position = [194,1038]
        screen.blit(eb, eb_position)
    if s.game.extra_ball.position >= 3:
        eb_position = [257,1039]
        screen.blit(eb, eb_position)
    if s.game.extra_ball.position >= 4:
        eb_position = [323,1036]
        screen.blit(eb_number, eb_position)
...
def line1_animation(args):
    ...
    if line == 1:
        ...
        if (s.game.anti_cheat.status == True):
            dirty_rects.append(screen.blit(bg_gi, (221,264), pygame.Rect(221,264,270,408)))
        else:
            dirty_rects.append(screen.blit(bg_off, (221,264), pygame.Rect(221,264,270,408)))
    
        dirty_rects.append(screen.blit(bg_gi, (34,209), pygame.Rect(34,209,305,87)))
...
def line3_animation(args):
    ...
    if line == 3:
        ...
        dirty_rects.append(screen.blit(number_card, nc_p))
        if (s.game.anti_cheat.status == True):
            dirty_rects.append(screen.blit(bg_gi, (389,369), pygame.Rect(389,369,270,212)))
        else:
            dirty_rects.append(screen.blit(bg_off, (389,369), pygame.Rect(389,369,270,212)))
