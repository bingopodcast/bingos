...
class MulticardBingo(procgame.game.Mode):
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh blue_chip")
        else:
            if self.game.ball_count.position >= 4:
                self.game.sound.stop_music()
    ...
    def replay_step_up(self):
        if self.game.replays < 8999:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.blue_chip.reel1, graphics.blue_chip.reel10, graphics.blue_chip.reel100, graphics.blue_chip.reel1000)
...
class BlueChip(procgame.game.BasicGame):
    ...
    def __init__(self, machine_type):
        ...
        self.spotting = units.Stepper("spotting", 5, "blue_chip", "continuous")
...
game = BlueChip(machine_type='pdb')
game.reset()
game.run_loop()
