...
class SinglecardBingo(procgame.game.Mode):
        ...
        if self.game.start.status == True:
            ...
            if red_letter > 0:
                ...
                if self.game.magic_screen.position > 0:
                    print self.game.magic_screen.position
    ...
    def golden_game_screen_reset(self, number):
        if number > 0:
            ...
            self.delay(name="display", delay=0, handler=graphics.silver_sails.display, param=self)
            number -= 1
            self.delay(name="golden_game_screen_reset", delay=0.1, handler=self.golden_game_screen_reset, param=number)
...
#        self.cancel_delayed(name="blink_title")
    ...
    def animate_odds_scan(self, s):
        if s > 1:
            self.delay(name="odds_animation", delay=0.1, handler=graphics.silver_sails.odds_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.silver_sails.display, param=self)
            s -= 1
    ...
    def animate_feature_scan(self, s):
        if s > 1:
            self.delay(name="feature_animation", delay=0.1, handler=graphics.silver_sails.feature_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.silver_sails.display, param=self)
            s -= 1
    ...
    def animate_eb_scan(self, s):
        if s > 1:
            self.delay(name="eb_animation", delay=0.1, handler=graphics.silver_sails.eb_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.silver_sails.display, param=self)
            s -= 1
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [167,257]
            image = pygame.image.load('silver_sails/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [241,290]
            image = pygame.image.load('silver_sails/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [346,298]
            image = pygame.image.load('silver_sails/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
        if title4 == 1:
            pos = [431,264]
            image = pygame.image.load('silver_sails/assets/title4_on.png').convert_alpha()
            screen.blit(image, pos)
