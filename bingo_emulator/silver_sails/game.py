...
from bingo_emulator.graphics.silver_sails import *
...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        if self.game.start.status == True:
            ...
            self.game.features.disengage()
            self.regular_play()
        self.delay(name="display", delay=0.1, handler=graphics.silver_sails.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh silver_sails")
        else:
    ...
    def regular_play(self, red_letter=0, gold_odds=0):
        ...
        if self.game.start.status == True:
            ...
            graphics.silver_sails.display(self)
            self.check_lifter_status()
        else:
            if red_letter > 0:
                if self.game.switches.shutter.is_inactive():
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.silver_sails.reel1, graphics.silver_sails.reel10, graphics.silver_sails.reel100)
                self.game.coils.registerDown.pulse()
                number -= 1
                self.delay(name="display", delay=0, handler=graphics.silver_sails.display, param=self)
    ...
    def replay_step_up(self):
        if self.game.replays < 899:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.silver_sails.reel1, graphics.silver_sails.reel10, graphics.silver_sails.reel100)
            ...
            if red_ss_winner == 2 or yellow_ss_winner == 2 or blue_winner == 2 or red_letter_winner >= 2:
                ...
                if self.game.ok.status == True:
                    if red_letter_winner >= 2:
                        ...
                        self.regular_play(red_letter, 0)
    ...
    def animate_odds_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.silver_sails.odds_animation([self, start + num])
    ...
    def animate_features_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.silver_sails.feature_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.silver_sails.both_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
    ...
    def animate_screen_right(self, args):
        ...
        num = args[1]
        if num >= 0:
            graphics.silver_sails.screen_animation([self, num, "right"])
            self.cancel_delayed(name="display")
            num = num - 1
    ...
    def animate_screen_left(self, args):
        ...
        num = args[1]
        if num >= 0:
            graphics.silver_sails.screen_animation([self, num, "left"])
            self.cancel_delayed(name="display")
            num = num - 1
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.silver_sails.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class SilverSails(procgame.game.BasicGame):
    """ Silver Sails was the last of the Gate games """
    def __init__(self, machine_type):
        super(SilverSails, self).__init__(machine_type)
        ...
        self.cu = 1
        self.cam4 = units.Stepper("cam4", 3, "silver_sails", "continuous")
        ...
        #Odds steppers
        self.red_odds = units.Stepper("red_odds", 8, 'silver_sails')
        self.yellow_odds = units.Stepper("yellow_odds", 8, 'silver_sails')
        self.green_odds = units.Stepper("green_odds", 8, 'silver_sails')
...
game = SilverSails(machine_type='pdb')
game.reset()
game.run_loop()
