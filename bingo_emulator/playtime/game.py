...
class SinglecardBingo(procgame.game.Mode):
    ...
    def find_winner(self, relays, card, corners, yellow, orange, red):
    ...
    def orange_replay_step_up(self, number):
        ...
        if number >= 1:
            ...
            if self.game.replays == 899:
                number = 0
            self.delay(name="orange_replay_step_up", delay=0.25, handler=self.orange_replay_step_up, param=number)
        else:
            self.game.search_index.disengage()
            self.cancel_delayed(name="orange_replay_step_up")
            self.search_sounds()
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.playtime.both_animation([self, start + num])
    ...
    def animate_squarea(self, args):
        ...
        square = args[2]
        if num < 55:
            graphics.playtime.squarea_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_squareb(self, args):
        ...
        square = args[2]
        if num < 55:
            graphics.playtime.squareb_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squarec(self, args):
        ...
        square = args[2]
        if num < 62:
            graphics.playtime.squarec_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squared(self, args):
        ...
        square = args[2]
        if num < 60:
            graphics.playtime.squared_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squaree(self, args):
        ...
        square = args[2]
        if num < 60:
            graphics.playtime.squaree_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.playtime.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class Playtime(procgame.game.BasicGame):
    """ Playtime was the last United game """
