...
class MulticardBingo(procgame.game.Mode):
    ...
    def horizontal_replay_step_up(self, number):
        ...
        if number >= 1:
            ...
            if self.game.replays == 899:
                number = 0
            self.delay(name="horizontal_replay_step_up", delay=0.25, handler=self.horizontal_replay_step_up, param=number)
        else:
            self.game.search_index.disengage()
    ...
    def features_probability(self):
        ...
        if self.game.horizontal.position >= 3:
            if sd == 2:
                self.game.horizontal.step()
        if sd == 20:
            if self.game.super_horizontal.status == False:
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.starlet.both_animation([self, start + num])
    ...
    def animate_roto(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.starlet.roto_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.starlet.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
