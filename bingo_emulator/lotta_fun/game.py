...
from bingo_emulator.graphics.lotta_fun import *
...
class MulticardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        ...
        self.delay(name="display", delay=0.1, handler=graphics.lotta_fun.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh lotta_fun")
...
#        self.cancel_delayed(name="blink_title")
        graphics.lotta_fun.display(self, 0)
        self.tilt_actions()
#        self.delay(name="blink_title", delay=1, handler=self.blink_title)
    ...
    def replay_step_up(self):
        ...
        graphics.lotta_fun.display(self)
...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [2,450]
            image = pygame.image.load('lotta_fun/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [126,460]
            image = pygame.image.load('lotta_fun/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
...
class LottaFun(procgame.game.BasicGame):
    """ Lotta Fun was the first Ohio Dime Game with a red button """
    def __init__(self, machine_type):
        super(LottaFun, self).__init__(machine_type)
...
game = LottaFun(machine_type='pdb')
game.reset()
game.run_loop()
