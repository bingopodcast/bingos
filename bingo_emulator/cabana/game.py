...
class MulticardBingo(procgame.game.Mode):
    ...
    def animate_feature_scan(self, s):
        if s > 1:
            self.delay(name="feature_animation", delay=0.1, handler=graphics.cabana.feature_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.cabana.display, param=self)
            s -= 1
    ...
    def animate_eb_scan(self, s):
        if s > 1:
            self.delay(name="eb_animation", delay=0.1, handler=graphics.cabana.eb_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.cabana.display, param=self)
            s -= 1
