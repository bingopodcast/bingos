...
class SinglecardBingo(procgame.game.Mode):
    ...
    def animate_odds_scan(self, s):
        if s > 1:
            self.delay(name="odds_animation", delay=0.1, handler=graphics.safari.odds_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.safari.display, param=self)
            s -= 1
    ...
    def animate_feature_scan(self, s):
        if s > 1:
            self.delay(name="feature_animation", delay=0.1, handler=graphics.safari.feature_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.safari.display, param=self)
            s -= 1
    ...
    def animate_eb_scan(self, s):
        if s > 1:
            self.delay(name="eb_animation", delay=0.1, handler=graphics.safari.eb_animation, param=s)
            self.delay(name="display", delay=0.1, handler=graphics.safari.display, param=self)
            s -= 1
