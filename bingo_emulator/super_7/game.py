...
from bingo_emulator.graphics.super_7 import *
...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        if self.game.start.status == True:
            ...
            self.regular_play()
        self.delay(name="display", delay=0.1, handler=graphics.super_7.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh super_7")
        else:
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.super_7.reel1, graphics.super_7.reel10, graphics.super_7.reel100, graphics.super_7.reel1000)
                self.game.coils.registerDown.pulse()
                number -= 1
                self.delay(name="display", delay=0, handler=graphics.super_7.display, param=self)
    ...
    def replay_step_up(self):
        if self.game.replays < 8999:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.super_7.reel1, graphics.super_7.reel10, graphics.super_7.reel100, graphics.super_7.reel1000)
    ...
    def animate_special(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.super_7.special_animation([self, start + num])
    ...
    def animate_line1(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.super_7.line1_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_line2(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.super_7.line2_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_line3(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.super_7.line3_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_odds_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.super_7.odds_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_features_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.super_7.feature_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.super_7.both_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.super_7.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class Super7(procgame.game.BasicGame):
    """ Super 7 is one of two games with a bonus 7s game. """
    def __init__(self, machine_type):
        ...
        #Odds steppers
        self.red_odds = units.Stepper("red_odds", 10, 'super_7')
        self.yellow_odds = units.Stepper("yellow_odds", 10, 'super_7')
        self.green_odds = units.Stepper("green_odds", 10, 'super_7')
        self.blue_odds = units.Stepper("blue_odds", 10, 'super_7')
        ...
        self.line1 = units.Stepper("line1", 3, "super_7", "continuous")
        self.line2 = units.Stepper("line2", 1, "super_7", "continuous")
        self.line3 = units.Stepper("line3", 1, "super_7", "continuous")
        ...
        self.special_odds = units.Stepper("special_odds", 9, 'super_7')
