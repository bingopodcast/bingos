...
from bingo_emulator.graphics.bahama_beach import *
...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh bahama_beach")
        else:
    ...
    def step_selection(self, number):
        if number >= 1:
            self.game.selection_feature.step()
            if self.game.mystic_lines.position >= 4 or self.game.two_red_letter == True or self.game.three_red_letter == True:
    ...
    def animate_line1(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.bahama_beach.line1_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_line2(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.bahama_beach.line2_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
    ...
    def animate_line3(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.bahama_beach.line3_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,line]
...
class BahamaBeach(procgame.game.BasicGame):
    ...
    def __init__(self, machine_type):
        ...
        #Odds steppers
        self.red_odds = units.Stepper("red_odds", 10, 'bahama_beach')
        self.yellow_odds = units.Stepper("yellow_odds", 10, 'bahama_beach')
        self.green_odds = units.Stepper("green_odds", 10, 'bahama_beach')
        self.blue_odds = units.Stepper("blue_odds", 10, 'bahama_beach')
        ...
        self.line1 = units.Stepper("line1", 3, "bahama_beach", "continuous")
        self.line2 = units.Stepper("line2", 1, "bahama_beach", "continuous")
        self.line3 = units.Stepper("line3", 1, "bahama_beach", "continuous")
...
game = BahamaBeach(machine_type='pdb')
game.reset()
game.run_loop()
