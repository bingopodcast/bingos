...
class SinglecardBingo(procgame.game.Mode):
    ...
    def odds_probability(self):
        ...
        if self.game.odds.position == 1:
            ...
            if self.game.odds.position == 2:
                ...
                if sd in range(8,11) or sd in [14,21,24,41,46] or sd in range(16,19) or sd in range(30,33) or sd in range(38,40):
                    m2 = self.check_mixer2()
                    if m2 == True:
                        m3 = self.check_mixer3()
                        if m3 == True:
                ...
                if sd in [6,14,42,47,0] or sd in range(8,11) or sd in range(16,19) or sd in range(30,33):
                    m2 = self.check_mixer2()
                    if m2 == True:
                        m3 = self.check_mixer3()
                        if m3 == True:
                ...
                if sd in [2,3,12,21,28,35,36,49]:
                    m2 = self.check_mixer2()
                    if m2 == True:
                        m3 = self.check_mixer3()
                        if m3 == True:
    ...
    def features_spotting(self):
        ...
        if sd in [11,23,34]:
            self.step_ms(7 - self.game.magic_squares_feature.position)
        if sd in [4,5,7,13,16,20,22,26,27,42,44]:
            self.step_ms(4 - self.game.magic_squares_feature.position)
        elif sd in [2,6,10,17,28,31,35,38,46]:
            self.step_ms(5 - self.game.magic_squares_feature.position)
        elif sd in [3,8,9,14,30,35,38,46]:
            self.step_ms(7 - self.game.magic_squares_feature.position)
        else:
            self.step_ms(1)
        if sd in [15,20,27,42,45]:
            if self.game.top_line.status == False:
                self.game.top_line.engage(self.game)
                self.game.sound.play('tilt')
        if sd in [0,16,26,37,44]:
            if self.game.bottom_line.status == False:
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.parade.both_animation([self, start + num])
    ...
    def animate_squarea(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.parade.squarea_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_squareb(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.parade.squareb_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squarec(self, args):
        ...
        square = args[2]
        if num < 62:
            graphics.parade.squarec_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squared(self, args):
        ...
        square = args[2]
        if num < 65:
            graphics.parade.squared_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.parade.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
...
class Parade(procgame.game.BasicGame):
    """ Parade was the only game with extra lines """
