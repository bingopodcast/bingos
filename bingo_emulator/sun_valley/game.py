...
from bingo_emulator.graphics.sun_valley import *
...
class SinglecardBingo(procgame.game.Mode):
    ...
    def sw_coin_active(self, sw):
        if self.game.eb_play.status == False:
            ...
            graphics.sun_valley.display(self)
            self.animate_eb_scan([begin,self.game.spotting.movement_amount,self.game.spotting.movement_amount])

        self.delay(name="display", delay=0.1, handler=graphics.sun_valley.display, param=self)
    ...
    def sw_enter_active(self, sw):
        if self.game.switches.left.is_active() and self.game.switches.right.is_active():
            ...
            os.system("/home/nbaldridge/proc/bingo_emulator/start_game.sh sun_valley")
    ...
    def magic_squarea_reset(self, number):
        if number != 0:
            self.game.sound.play('square')
            self.game.square_a.step()
            self.delay(name="display", delay=0, handler=graphics.sun_valley.display, param=self)
            self.cancel_delayed("squarea_animation")
            self.animate_squarea([self.game,1,1])
    ...
    def replay_step_down(self, number=0):
        if number > 0:
            if number > 1:
                self.game.replays -= 1
                graphics.replay_step_down(self.game.replays, graphics.sun_valley.reel1, graphics.sun_valley.reel10, graphics.sun_valley.reel100)
    ...
    def replay_step_up(self):
        if self.game.replays < 899:
            self.game.replays += 1
            graphics.replay_step_up(self.game.replays, graphics.sun_valley.reel1, graphics.sun_valley.reel10, graphics.sun_valley.reel100)
    ...
    def animate_both(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.sun_valley.both_animation([self, start + num])
    ...
    def animate_line(self, args):
        ...
        line = args[2]
        if num < 55:
            graphics.sun_valley.line_animation([self, num * -1, line])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_squarea(self, args):
        ...
        square = args[2]
        if num < 55:
            graphics.sun_valley.squarea_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
    ...
    def animate_squareb(self, args):
        ...
        square = args[2]
        if num < 55:
            graphics.sun_valley.squareb_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squarec(self, args):
        ...
        square = args[2]
        if num < 62:
            graphics.sun_valley.squarec_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squared(self, args):
        ...
        square = args[2]
        if num < 60:
            graphics.sun_valley.squared_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_squaree(self, args):
        ...
        square = args[2]
        if num < 60:
            graphics.sun_valley.squaree_animation([self, num * -1, square])
            self.cancel_delayed(name="display")
            num = num + 1
            args = [self.game,num,square]
    ...
    def animate_eb_scan(self, args):
        ...
        if diff >= 0:
            num = num + 1
            graphics.sun_valley.eb_animation([self, start + num])
            self.cancel_delayed(name="display")
            diff = diff - 1
            args = [start,diff,num]
            self.delay(name="eb_animation", delay=0.09, handler=self.animate_eb_scan, param=args)
        else:
...
class SunValley(procgame.game.BasicGame):
    """ Sun Valley allows movement of all numbers on the bingo card """
    def __init__(self, machine_type):
        super(SunValley, self).__init__(machine_type)
        ...
        #Odds stepper
        self.red_odds = units.Stepper("red_odds", 8, 'sun_valley')
        self.yellow_odds = units.Stepper("yellow_odds", 8, 'sun_valley')
        self.green_odds = units.Stepper("green_odds", 8, 'sun_valley')
        ...
        self.square_a = units.Stepper("square_a", 3, "sun_valley", "continuous")
        self.square_b = units.Stepper("square_b", 3, "sun_valley", "continuous")
        self.square_c = units.Stepper("square_c", 3, "sun_valley", "continuous")
        self.square_d = units.Stepper("square_d", 3, "sun_valley", "continuous")
        self.square_e = units.Stepper("square_e", 3, "sun_valley", "continuous")
        self.line_f = units.Stepper("line_f", 3, "sun_valley", "continuous")
...
game = SunValley(machine_type='pdb')
game.reset()
game.run_loop()
