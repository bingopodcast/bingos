...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [418,264]
            image = pygame.image.load('fun_spot_63/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [543,250]
            image = pygame.image.load('fun_spot_63/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [656,250]
            image = pygame.image.load('fun_spot_63/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
