...
#        self.delay(name="blink_title", delay=3, handler=self.blink_title)
    ...
    def blink_title(self):
        ...
        if title1 == 1:
            pos = [298,215]
            image = pygame.image.load('zingo/assets/title1_on.png').convert_alpha()
            screen.blit(image, pos)
        if title2 == 1:
            pos = [181,239]
            image = pygame.image.load('zingo/assets/title2_on.png').convert_alpha()
            screen.blit(image, pos)
        if title3 == 1:
            pos = [385,243]
            image = pygame.image.load('zingo/assets/title3_on.png').convert_alpha()
            screen.blit(image, pos)
